        ...
        <div className="grid grid-cols-2 items-center">
          <div>
            ...
            <div className="grid grid-cols-6 items-center text-white">
              <p className="col-span-5 max-h-[70px] overflow-hidden">{data[3].content}</p>
              <span className="bg-accent w-fit rounded-full p-6"><FaQuoteRight className="text-4xl" /></span>
            </div>
          </div>
          <div><img src={data[3].image} alt="" /></div>
        </div>
      </div>
    </section>
  );
